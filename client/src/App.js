    ...
    <>
      <div className="wrapper">
        ...
        <Routes>
          ...
          <Route
            path="/customerdash"
            element={<Customer restaurants={restaurants} user={user} />}
          />
          <Route
            path="/customerdash/orders"
            element={
              <CustomerOrders restaurants={restaurants} orders={orders} />
            }
          />
          <Route
            path="/customerdash/profile"
            element={
              <CustomerProfile restaurants={restaurants} orders={orders} />
            }
          />

          <Route
            path="/customerdash/loyalty points"
          ...
          />
          <Route
            path="/customerdash/reviews"
            element={
              <CustomerReviews restaurants={restaurants} orders={orders} />
            }
          />
          <Route
            path="/customerdash/bookings"
            element={
              <CustomerBookings restaurants={restaurants} orders={orders} />
            }
          />
          <Route
            path="/customerdash/statements"
            element={
              <CustomerStatements restaurants={restaurants} orders={orders} />
            }
          />
          <Route
          ...
          <Route
            path="/create+your=accountadmindash/addfood"
          ...
          <Route
            path="/admindash/password/termsandconditions"
          ...
          <Route
            path="/blogprofile/:id"
            element={<BlogProfile users={users} />}
          />

          <Route
            path="/blog/fullcontent/:id"
            element={<BlogDetail blogs={blogs} />}
          />
          <Route path="/contactus" element={<ContactMe />} />
          <Route path="/restaurantdash" element={<Restaurantdash />} />
          <Route
            path="/restaurantdash/profile"
            element={<RestaurantProfile />}
          />
          <Route
            path="/restaurantdash/addfood"
            element={<RestaurantAddfood />}
          />
          <Route path="/restaurantdash/foods" element={<RestaurantFoods />} />
          <Route
            path="/restaurantdash/reviews"
            element={<RestaurantReviews />}
          />
          <Route
            path="/restaurantdash/settlements"
            element={<RestaurantSettlements />}
          />
          <Route
            path="/restaurantdash/bookings"
            element={<RestaurantBookings />}
          />
          <Route
            path="/restaurantdash/password"
            element={<RestaurantPassword />}
          />
                  ...
                  {showLogin && showReset ? (
                    <>
                      ...
                      <div
                        ...
                        className="signin-tab-link forget-password"
                      >
                        New Here?
                        <span
                          onClick={() => {
                        ...
                        >
                          {" "}
                          <Link to="/create+your=account">Sign Up</Link>
                        </span>
                        <br />
                      </div>
