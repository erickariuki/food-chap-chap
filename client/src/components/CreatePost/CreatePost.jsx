...
const Post = () => {
  ...
  const onSubmit = async ({ title, postedBy, tags, body }) => {
    const payload = {
      title,
      postedBy,
    ...
    <Container className="my-5" style={{ maxWidth: '800px' }}>
      ...
      <Form onSubmit={handleSubmit(onSubmit)} className="my-5">
        ...
        <Form.Group className="mb-3">
          ...
          <Form.Control type="text" placeholder="Enter author" {...register('postedBy')} />
        </Form.Group>
        <Form.Group className="mb-3">
        ...
        <Form.Group className="mb-3">
          ...
          <Form.Control as="textarea" rows={3} placeholder="Your content..." {...register('body')} />
        </Form.Group>
